# -*- coding: utf-8 -*-
"""
This module contains the Parameters class that
is used to specify the input parameters of the tree.
"""
...
class Parameters:
    ...
    Attributes:
        meshfile (str):
            path and filename to obj file name.
        filename (str):
    ...
    def __init__(self):
        ...
        self.w = 0.1
        # Length of the segments (approximately, because
